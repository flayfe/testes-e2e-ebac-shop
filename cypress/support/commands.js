...
Cypress.Commands.add('PesquisarProduto', (prod) => {
    cy.xpath('//section[@class="tbay-mainmenu hidden-xs hidden-sm"]//li[contains(@class,"menu-item-629")]').click()
    cy.xpath('//div[@class="header-main clearfix"]//input[contains(@class,"tbay-search")]').type(prod + '{enter}')
})
...
Cypress.Commands.add('AlterarEnderecoFaturamento', (firstName,lastName,company,country,address,number,city,state,postcode,phonenumber,email,comments) => { 
