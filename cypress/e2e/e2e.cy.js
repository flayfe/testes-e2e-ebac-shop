...
context('Exercicio - Testes End-to-end - Fluxo de pedido', () => {
  ...
  it('Deve fazer um pedido na loja Ebac Shop de ponta a ponta - Cliente já cadastrado', () => {
    ...
    const prod2 = 'Argus All-Weather Tank'
    const prod3 = 'Aether Gym Pant'
    const prod4 = 'Ajax Full-Zip Sweatshirt'
    const qtd = 2
    ...
    cy.AdicionarProdutoCarrinho(prod2, qtd, 'M', 'Gray')

    //adicionando o terceiro produto
    cy.PesquisarProduto(prod3)
    cy.AdicionarProdutoCarrinho(prod3, qtd, 34, 'Green')

    //adicionando o quarto produto
    cy.PesquisarProduto(prod4)
    cy.AdicionarProdutoCarrinho(prod4, qtd, 'L', 'Blue')
